 ...
 * @param {type} width 一桢的宽度
 * @param {type} height 一桢的高度
 * @param {type} offsetX 初始偏移X
 * @param {type} offsetY 初始偏移Y
 * @param {type} frames 总共frame
 * @param {type} duration 动画经历时间
 * @returns {Sprite}
 */
...
Sprite.prototype.draw = function(c, drawShadow) {
	...
	Sprite.prototype.drawShadow = function(c){
